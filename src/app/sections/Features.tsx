      ...
      <div className="container mx-auto px-4">
        <SectionContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 place-items-center">
            ...
            {/* Revolving orbit system */}
            <div className="flex justify-center">
              <div className="features-orbital-system">
                {/* Static orbits for visual reference */}
                <div className="features-orbit-ring outer-ring">
                  <Orbit className="size-full" />
                </div>
                <div className="features-orbit-ring inner-ring">
                  <Orbit className="size-[180px]" />
                </div>
                
                {/* Center logo */}
                <div className="features-center-logo">
                  <Logo className="size-24" />
                </div>
                
                {/* Revolving logos container */}
                <div className="features-logos-orbit">
                  {logos.map(({src, alt, rotate}, index) => (
                    <div
                      key={alt}
                      className={`features-logo-item logo-${index + 1}`}
                      data-initial-rotation={rotate}
                    >
                      <div className="features-logo-card">
                        <Image src={src} alt={alt} className="features-logo-image" />
                      </div>
                    </div>
                  ))}
                </div>
